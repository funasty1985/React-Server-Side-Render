            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            // api referred to the axios instance from the client or server
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // route map 
...
exports.default = [_extends({}, _App2.default, { // no path means the component will be shown in every page
...
app.get('*', function (req, res) {
    ...
    var promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref) {
        ...
        return route.loadData ? route.loadData(store) : // we will load the data we want into the store. 
...
exports.default = {
    ...
    } // work on SSR server matchRoutes() call 
};
...
exports.default = function (ChildComponent) {
        ...
        _createClass(RequireAuth, [{
            ...
            value: function render() {
                switch (this.props.auth) {
                    ...
                    default:
                        return _react2.default.createElement(ChildComponent, this.props); // props pass to the HOC will pass to <ChildComponent/>
                }
            }
        }]);
    ...
    return (0, _reactRedux.connect)(mapStateToProps)(RequireAuth); // HOC 
};
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        default:
            return state; // return intial state [], if no case is hit 
    }
};
